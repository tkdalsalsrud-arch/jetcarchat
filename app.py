...
if prompt := st.chat_input("무엇이든 물어보세요"):
    ...
    with st.spinner("jetcar가 생각 중... 🚙💨"):
        try:
            ...
            [지시]
            1. 위 [jetcar 참고 자료]에 기반해서 [사용자 질문]에 대답해 줘. 
            2. 만약 [참고 자료]에 답이 없다면, "제가 아는 정보 중에는 없습니다."라고 대답해.
            3. 답변은 한국어로 해 줘.
            4. 만약 차량번호만 입력하면 그 차량에 대한 모든 정보를 요약해서 알려주면서 '이런 분들께 추천 !'은 직접 생각해서 새로 작성해줘.
                요약은 다음 형식을 따라줘:
